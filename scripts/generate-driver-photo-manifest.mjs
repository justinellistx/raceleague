...
function main() {
  if (!fs.existsSync(photosDir)) {
    console.log("❌ public/drivers-photos folder not found:", photosDir);
    return;
  }
  ...
  for (const file of files) {
    ...
    // Prefer png if duplicates exist
  ...
  console.log(`✅ Driver photo manifest created: ${outFile} (${Object.keys(manifest).length} entries)`);
}
